...
if(HF3FS_ENABLE_GDR)
    ...
    if(CMAKE_VERSION VERSION_GREATER_EQUAL "3.17")
        ...
        if(CUDAToolkit_FOUND)
            ...
            message(STATUS "  CUDA libraries: CUDA::cudart;CUDA::cuda_driver")
        endif()
    else()
        ...
        if(CUDA_FOUND AND CUDA_CUDA_LIBRARY)
            ...
            message(STATUS "  CUDA libraries: ${HF3FS_CUDA_LIBRARIES}")
        elseif(CUDA_FOUND)
            message(STATUS "Legacy CUDA discovery did not provide the required driver library")
        endif()
    endif()
...
function(target_add_gdr_support TARGET)
    ...
    if(HF3FS_GDR_AVAILABLE)
        ...
        # libraries to their final consumers.
